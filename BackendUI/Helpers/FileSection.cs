...
namespace BackendUI.Helpers
{
    public class FileSection
    {
        ...
        public enum FileTypeWidths
        {
            ...
            BlogPrimary = 356, BlogSidebar = 300, BlogSidebarBanner = 300, BlogBanner = 300, BlogSlider = 300, BlogContent = 825,
        ...
        public enum FileTypeHeights
        {
            ...
            ProductPrimary = 600, ProductSidebarBanner = 300, ProductBanner = 300, ProductSlider = 300,
            BlogPrimary = 244, BlogSidebar = 300, BlogSidebarBanner = 300, BlogBanner = 300, BlogSlider = 300, BlogContent = 567,
